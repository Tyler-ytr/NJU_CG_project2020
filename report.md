...
![image-20200331000955808](picture/image-20200331000955808.png)
...
![image-20200331015413585](picture/image-20200331015413585.png)
...
![image-20200331020838750](picture/image-20200331020838750.png)
...
![image-20200331023204271](picture/image-20200331023204271.png)
...
![img](picture/bezier-quadratic-end.png)
...
- De Casteljau’s Algorithm的思想是: 为了计算第n次贝塞尔曲线的点C(u),$u\in [0,1]$，首先需要将控制点连成一条折线,00-01-02....0(n-1)-0n;然后利用上面的方法得到0j-0(j+1)上的分割点1j,使得1j分该线段的比值为u:1-u;然后在折线10-11.....1(n-1)上面递归调用该算法,以此类推直到n0;上述的方法可以直观的表示成下图:
  ...
  ![img](picture/de-cast-compute.jpg)
...
![img](picture/cohen-sutherland.png)
